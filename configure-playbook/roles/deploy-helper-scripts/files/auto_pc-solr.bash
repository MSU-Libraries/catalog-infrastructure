_pc-locate-hlm()
{
    ...
    if [[ $COMP_CWORD -eq 1 ]]; then
        # Get all the environment directory names in LOCAL_DIR
        readarray -d '' DEPLOY_ENVS < <(find ${LOCAL_DIR} \
            -maxdepth 1 -mindepth 1 -type d \
            -exec realpath --relative-to ${LOCAL_DIR} {} \;)
